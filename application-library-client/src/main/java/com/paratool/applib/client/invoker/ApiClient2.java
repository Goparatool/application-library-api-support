...
import com.paratool.applib.client.invoker.auth.Authentication;
import com.paratool.applib.client.invoker.auth.HttpBasicAuth;
import com.paratool.applib.client.invoker.auth.ApiKeyAuth;
import com.paratool.applib.client.invoker.auth.OAuth;

@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2015-11-12T19:28:38.512+08:00")
public class ApiClient2 {
	private Client client;
	private Map<String, Client> hostMap = new HashMap<String, Client>();
	private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
	private boolean debugging = false;
	private String basePath = "http://localhost/uoapi";
	 ...
	 *            The header's value
	 */
	public ApiClient2 addDefaultHeader(String key, String value) {
	 ...
	 */
	public ApiClient2 setDebugging(boolean debugging) {
	 ...
	 */
	public ApiClient2 setDateFormat(DateFormat dateFormat) {
	 ...
	 */
	public Entity<String> serialize(Object obj, String contentType)
			throws ApiException {
		if (contentType.startsWith("application/json")) {
			return Entity.json(json.serialize(obj));
		} else {
			throw new ApiException(400,
					"can not serialize object into Content-Type: "
							+ contentType);
		}
	}
	 ...
	 */
	public <T> T deserialize(Response response, TypeRef returnType)
			throws ApiException {
		...
		if (contentType.startsWith("application/json")) {
			...
			throw new ApiException(500, "Content type \"" + contentType
					+ "\" is not supported for type: " + returnType.getType());
		}
	}
	 ...
	 */
	public <T> T invokeAPI(String path, String method, List<Pair> queryParams,
			Object body, Map<String, String> headerParams,
			Map<String, Object> formParams, String accept, String contentType,
		...
		if (contentType.startsWith("multipart/form-data")) {
			...
			for (Entry<String, Object> param : formParams.entrySet()) {
				if (param.getValue() instanceof File) {
					...
					mp.bodyPart(new FormDataBodyPart(param.getKey(), file
							.getName()));
					multipart.bodyPart(mp, MediaType.MULTIPART_FORM_DATA_TYPE);

					multipart.bodyPart(new FileDataBodyPart(param.getKey(),
							file, MediaType.APPLICATION_OCTET_STREAM_TYPE));
				} else {
					FormDataMultiPart mp = new FormDataMultiPart();
					mp.bodyPart(new FormDataBodyPart(param.getKey(),
							parameterToString(param.getValue())));
					multipart.bodyPart(mp, MediaType.MULTIPART_FORM_DATA_TYPE);
				}
			}
			formEntity = Entity.entity(multipart,
	...
	public Map<String, List<String>> buildResponseHeaders(Response response) {
		...
		for (Entry<String, List<Object>> entry : response.getHeaders()
				.entrySet()) {
	 ...
	 *            The authentications to apply
	 */
	private void updateParamsForAuth(String[] authNames,
			List<Pair> queryParams, Map<String, String> headerParams) {
